...
- Los specs se reparten en dos proyectos: `readonly` (paralelo, `--workers=4`) y `stateful` (serial, muta estado compartido: forgot-password, password-change, directiva, admin-stateful). No paralelizar `stateful` con nada.
